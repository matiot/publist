...
\title{Publications}                               % optional, remove / comment the line if not wanted
...
\usepackage{multibib}
\newcites{pap,proc}{{Publications on peer-reviewed journals},{Conference proceedings}}
%----------------------------------------------------------------------------------
%            content
%----------------------------------------------------------------------------------
\begin{document}
...
\nocitepap{*}
\bibliographystylepap{unsrt}
\bibliographypap{bib/papers}

\nociteproc{*}
\bibliographystyleproc{unsrt}
\bibliographyproc{bib/proceedings}
